# Derivar funcionalitats essencials dels UC de les apps client
...
* Autenticar usuaris y vore els que tenen privilegis d'administració en odoo.


2 UC2 – Pujar vídeo

* Permetre carregar un .mp4 al sistema.


3 UC3 – Rebre metadades del servidor

* Agafar la informació d'un vídeo pendent que te que acceptar l'admin o ja pujat.


4 UC4 – Editar metadades

* Modificar la informació associada a un vídeo.


5 UC5 – Confirmar i registrar vídeo

* Validar la informació i fer que el vídeo sigui accessible per a ser penjat i reproduït.


6 UC6 – Modificar vídeo existent

* Actualitzar la informació d'una pel·lícula ja publicada.


7 UC7 – Eliminar vídeo
...
* Donar opció de compte ya existent.
